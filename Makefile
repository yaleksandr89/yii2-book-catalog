...
php-lint: check-env
	@$(COMPOSE) exec --user app php bash -lc 'find assets commands config controllers mail migrations models services tests views web widgets -type f -name "*.php" -print0 | xargs -0 -n1 php -l; php -l yii'
